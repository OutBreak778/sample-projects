  ...
  return (
    <div>
      ...
      <div className="relative md:w-full w-[400px] md:h-[510px] h-[350px] mb-12 ">
        <video
          className="w-full h-full rounded-[5px] object-cover z-0"
          src={vid}
          autoPlay
          muted
          loop
          playsInline
        ></video>
        <div className="shadow-[inset_-50px_-35px_83px_50px_rgba(0,_0,_0,_0.2)] absolute top-0 left-0 w-full h-full pointer-events-none z-0"></div>
